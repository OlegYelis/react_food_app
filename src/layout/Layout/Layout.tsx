      ...
      <div className={styles.sidebar}>
        <div className={styles.user}>
          <img
            ...
            src={import.meta.env.BASE_URL + "/images/user_avatar.webp"}
            alt="user"
            width="90px"
          />
            ...
            <svg className={styles.link__icon} width="23px" height="23px">
              <use
                href={
                  ...
                  "/images/icons.svg#icon-text-document"
                }
              ></use>
            </svg>
            Menu
          ...
          >
            <svg className={styles.link__icon} width="23px" height="23px">
              <use
                href={
                  import.meta.env.BASE_URL +
                  "/images/icons.svg#icon-shopping-basket"
                }
              ></use>
            </svg>
            Cart
        ...
        <Button className={styles.exit} onClick={logOutHandler}>
          <svg className={styles.exit__icon} width="20px" height="20px">
            <use
              href={import.meta.env.BASE_URL + "/images/icons.svg#icon-log-out"}
            ></use>
          </svg>
          Exit
        </Button>
